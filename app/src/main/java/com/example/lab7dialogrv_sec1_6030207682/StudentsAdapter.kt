...
import com.example.lab7dialogrv_sec1_6030207682.R
...
class StudentsAdapter(val items : List<Student>, val context: Context) : RecyclerView.Adapter<ViewHolder>(){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view_item = LayoutInflater.from(parent.context).inflate(R.layout.std_item_layout, parent,false)//To change body of created functions use File | Settings | File Templates.
